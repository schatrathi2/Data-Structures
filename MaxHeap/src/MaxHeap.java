...
public class MaxHeap<T extends Comparable<? super T>> {
    ...
    public MaxHeap(ArrayList<T> data) {
        ...
        for (int i = 0; i < data.size(); i++) {
            if (data.get(i) == null) {
                throw new IllegalArgumentException("There is null data in the list");
            }
    ...
    /**
     * Sorts a subtree so that it is a max heap.
     * @param curr index of root of current subtree
     */
    private void heapify(int curr) {
        ...
        if (max != curr) {
            ...
            backingArray[curr] = backingArray[max];
    ...
    public void add(T data) {
        ...
        T temp = backingArray[curr];
        while (backingArray[curr / 2] != null && curr > 0 && temp.compareTo(backingArray[curr / 2]) > 0) {
            backingArray[curr] = backingArray[curr / 2];
            curr = curr / 2;
            backingArray[curr] = temp;
        }
    }
